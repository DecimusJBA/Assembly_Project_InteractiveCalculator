...
Msg1		byte  " |/        CREATED BY:                                     \|", CR, LF, NULL
Msg2   		byte  " |\  _____         _   _      ____      _                  /|",CR,LF
			byte  " |/ | __  |___ ___| |_| |_   |    \ ___| |_ _____ ___ ___  \|",CR,LF
			byte  " |\ | __ -|  _| -_|  _|  _|  |  |  | .'|   |     | -_|  _| /|",CR,LF
			byte  " |/ |_____|_| |___|_| |_|    |____/|__,|_|_|_|_|_|___|_|   \|", CR, LF, NULL
...
SetupCalculator proc
	...
	lea edi, Msg2			   ;string for Name in ASCII Art style.
	call WriteStr			   ;write to console.
